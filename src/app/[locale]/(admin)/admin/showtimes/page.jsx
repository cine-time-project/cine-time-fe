...
export default function ShowtimesListPage() {
  ...
  const query = useMemo(() => ({
    ...
    hallId: Number(hallId) || undefined,    // BE şu an ignore etse bile sorun olmaz
  ...
  return (
    <div className="container-fluid">
      <div className="d-flex justify-content-between align-items-center mb-3">
        ...
        <button className="btn btn-primary" onClick={() => router.push("./showtimes/new")} disabled={isPending}>
          + New
        </button>
      </div>
